...
import {jer_30_10_11, jer_30_1_6, jer_30_7} from '@books/Jeremiah/jer_30';
import {matt_24_21} from '@books/Matthew/matt_24';
...
export class JacobsTrouble extends BasePageWithSubtitle {
  override pageSubtitle = "Eschatology - Jacob`s Trouble";
