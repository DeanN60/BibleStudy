...
export const rom_9_11_16 = new VerseData(
  "Romans 9:11-16 LSB",
  ...
  "Bibles, Steadfast; Foundation, The Lockman . The Legacy Standard Bible - LSB (pp. 3785-3786). 316 Publishing, Inc.. Kindle Edition."
)
