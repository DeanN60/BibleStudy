...
export const rev_1_3 = new VerseData(
  "Revelation 1:3 LSB",
  ...
  "Bibles, Steadfast; Foundation, The Lockman . The Legacy Standard Bible - LSB (p. 4110). 316 Publishing, Inc.. Kindle Edition."
);

export const rev_1_7 = new VerseData(
  "Revelation 1:7 LSB",
