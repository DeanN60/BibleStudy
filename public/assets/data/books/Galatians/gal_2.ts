...
export const gal_2_15_21 = new BookData(
  ...
  "21 I do not set aside the grace of God, for if righteousness comes through athe Law, then Christ died needlessly.”",
  "Bibles, Steadfast; Foundation, The Lockman . The Legacy Standard Bible - LSB (p. 3899). 316 Publishing, Inc.. Kindle Edition."
);
