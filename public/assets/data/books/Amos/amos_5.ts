...
export const amos_5_18_20 = new BookData(
  ...
  "20 Will not the day of Yahweh be darkness instead of light, Even thick darkness with no brightness in it?",
  "Bibles, Steadfast; Foundation, The Lockman . The Legacy Standard Bible - LSB (p. 3112). 316 Publishing, Inc.. Kindle Edition."
);
